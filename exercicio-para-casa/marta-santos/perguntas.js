...
*/
/*
Objeto é uma coleção de dados ou funcionalidades que possuem propriedades e métodos que podem ser 
acessados. Onde nesses objetos existem chaves e valores associados, onde estes valores são funções sendo consideradas o método do objeto. Este é importante para a linguagem javascript porque tudo dento do JS é um objeto. 
...
/*
A Arrow Function tem uma sintaxe mais curta do que a function, e uma das diferenças entre elas é que 
o Arrow Function não cria o seu próprio this, ou seja, ele mantém a referência do this como o elemento 
pai.
*/
...
const {tipo, raca, cor} = animal
console.log(tipo, raca, cor)

// EXEMPLO COM ARRAY //
const objetos = ["copo", "tesoura", "garfo", "prato"]
...
listaCompras("batata", "pão", "doce", "açúcar")
...
*/
/*
O Fetch é utilizado pra iniciar requisições com operações assíncronas e pra transferir dados entre recursos da web.
*/

/*
 Crie um exemplo utilizando Fetch
*/
const nomeUsuario = "martasantos89"
...
*/
const nomeUsuario2 = "martasantos89"
...
*/
const lista = ["item: uva", "item: maçã", "item: banana", "item: laranja mimo"]

const exemploFilter = lista.filter(function(fruta){
  return fruta.includes("uva")
})
...
const corBlusa = blusa === "preta" && "Sua blusa é preta"
